			...
			<ul class="nav nav-pills pull-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="<?php echo base_url(); ?>backend/search-index/" >search index</a>
						</li>
						<li>
							<a href="<?php echo base_url(); ?>backend/browse-node-id/">browse node id</a>
						</li>
						<li>
							<a href="<?php echo base_url(); ?>backend/manage-users/">manage users</a>
						</li>
					</ul>
				</li>
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="<?php echo base_url(); ?>backend/profile" >profile</a>
						</li>
						<li>
