...
class Campaign_wordpress extends CI_Controller {
	...
	function do_post()
	{
		...
		$categories = array("Uncategorized", "PHP Hypertext Preprocessor");
		$bloguser = 'L4jangL4ntangJ4lang';
		$blogpass = 'SetO123';
		$blogid = 1; 
		$publishImmediately = TRUE;

		$thePost = array(array('title'  => array('Aku Ini Orang Kaya','string'),
								'description'    => array('Aku ini orang kaya. Rumah saya ada 4 buah, rumah pertama saya di Curug, Cukanggalih. Rumah kedua saya di Taman Ubud, cluster sampingnya Lawson itu loh. Rumah ketiga di Kebumen, dekat dengan orangtua saya. Rumah ke empat di London, UK.
								This post is posted via xml rpc.','string'),
		...
		$this->xmlrpc->server('http://setoelkahfi.web.id/xmlrpc.php', 80);
